      ...
      <View style ={{flex:1,position:'absolute',top:0,bottom:0,left:0,right:0}}>
            ...
            stickyHeaderIndices={[0]}
               ...
               scrollEventThrottle = {16}>
                  <Animated.View style={[{height:this.headerHeight,width:width,backgroundColor: this.color,zIndex:1},styles.shadow]}>
                     <TextInput  onSubmitEditing ={()=>{this._firstDevice()}} style ={{flex:1,position:'absolute',top:50,bottom:50,left:20,right:20,backgroundColor:'coral',height:40}}/>
                  </Animated.View>
